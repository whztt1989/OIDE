...
{  
    /// <summary>
    /// KLasse stellt Methoden für den Zugriff auf DLL's bereit
    /// </summary>
    public class CDLL_Loader
    {
     //   IntPtr hmod; //Pointer auf DLL
       ...
       //     FixFPU();
        ...
        public IntPtr fLoadDLL_Fkt(String pFktName, IntPtr hmod)
        {
            ...
            try
            {
                ...
                fptr = CDLL_Loader.GetProcAddress(hmod, pFktName);
