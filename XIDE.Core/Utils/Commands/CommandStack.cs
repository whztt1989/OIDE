...
namespace XIDE.Core
{
	...
	public class CommandStack
	{
		...
		private void ReduceStackFromBottom(Stack<ICommand> stack, int numToRemove)
		{
			...
			else
			{
				...
				Stack<ICommand> reversedStack = new Stack<ICommand>(stack.Count);
		...
		public IEnumerable<ICommand> GetUndoCommandIterator()
		{
		...
		public IEnumerable<ICommand> GetRedoCommandIterator()
		{
			ICommand[] redoCmds = mRedoStack.ToArray();
