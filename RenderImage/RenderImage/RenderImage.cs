...
namespace MogreInWpf
{
    ...
    {
        PInvokeWrapper.Interface mPInvokeI;
    ...
    //    private static Dictionary<IntPtr, RenderWindow> renderWindows = new Dictionary<IntPtr, RenderWindow>();
        ...
        public MogreImage()
        {
            mPInvokeI = new PInvokeWrapper.Interface();
        }
        ...
        protected bool _InitOgreImage()
        {
            lock (this)
            {
                ...
                //    {
                   ...
                   //    bool test = PInvokeWrapper.DLL.CDLL_XE.startState(hWnd);

                      // bool test2= mPInvokeI.StartState(hWnd);
