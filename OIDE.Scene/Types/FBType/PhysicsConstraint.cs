...
public class PhysicsConstraint : Table {
  public static PhysicsConstraint GetRootAsPhysicsConstraint(ByteBuffer _bb) { return (new PhysicsConstraint()).__init(_bb.GetInt(_bb.position()) + _bb.position(), _bb); }
  ...
  public byte DisableLinkedCollision() { int o = __offset(18); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; }
  ...
  public static void AddDisableLinkedCollision(FlatBufferBuilder builder, byte disableLinkedCollision) { builder.AddByte(7, disableLinkedCollision, 0); }
