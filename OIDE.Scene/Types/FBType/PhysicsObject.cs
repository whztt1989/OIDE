...
public class PhysicsObject : Table {
  public static PhysicsObject GetRootAsPhysicsObject(ByteBuffer _bb, int offset) { return (new PhysicsObject()).__init(_bb.GetInt(offset) + offset, _bb); }
  ...
  public byte Type() { int o = __offset(6); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; }
  public int Mode() { int o = __offset(8); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; }
  public int Shape() { int o = __offset(10); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; }
  ...
  public int ColGroupMask() { int o = __offset(32); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; }
  ...
  public Vec3f Size(Vec3f obj) { int o = __offset(44); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  public Vec3f Scale() { return Scale(new Vec3f()); }
  public Vec3f Scale(Vec3f obj) { int o = __offset(46); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  public Vec3f Offset() { return Offset(new Vec3f()); }
  public Vec3f Offset(Vec3f obj) { int o = __offset(48); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  public byte ParentIsNode() { int o = __offset(50); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; }

  public static void StartPhysicsObject(FlatBufferBuilder builder) { builder.StartObject(24); }
  ...
  public static void AddMode(FlatBufferBuilder builder, int mode) { builder.AddInt(2, mode, 0); }
  public static void AddShape(FlatBufferBuilder builder, int shape) { builder.AddInt(3, shape, 0); }
  ...
  public static void AddColGroupMask(FlatBufferBuilder builder, int colGroupMask) { builder.AddInt(14, colGroupMask, 0); }
  ...
  public static void AddSize(FlatBufferBuilder builder, int sizeOffset) { builder.AddOffset(20, sizeOffset, 0); }
  public static void AddScale(FlatBufferBuilder builder, int scaleOffset) { builder.AddOffset(21, scaleOffset, 0); }
  public static void AddOffset(FlatBufferBuilder builder, int offsetOffset) { builder.AddOffset(22, offsetOffset, 0); }
  public static void AddParentIsNode(FlatBufferBuilder builder, byte parentIsNode) { builder.AddByte(23, parentIsNode, 0); }
  public static int EndPhysicsObject(FlatBufferBuilder builder) { return builder.EndObject(); }
};
