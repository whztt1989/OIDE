...
public class EntityBase : Table {
  public static EntityBase GetRootAsEntityBase(ByteBuffer _bb) { return GetRootAsEntityBase(_bb, new EntityBase()); }
  public static EntityBase GetRootAsEntityBase(ByteBuffer _bb, EntityBase obj) { return (obj.__init(_bb.GetInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public bool CastShadows() { int o = __offset(18); return o != 0 ? 0!=bb.Get(o + bb_pos) : (bool)false; }
  ...
  public static void AddCastShadows(FlatBufferBuilder builder, bool castShadows) { builder.AddBool(7, castShadows, false); }
