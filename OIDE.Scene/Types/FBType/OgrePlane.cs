...
public class OgrePlane : Table {
  public static OgrePlane GetRootAsOgrePlane(ByteBuffer _bb, int offset) { return (new OgrePlane()).__init(_bb.GetInt(offset) + offset, _bb); }
  public OgrePlane __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }

  public Vec3f Normal() { return Normal(new Vec3f()); }
  public Vec3f Normal(Vec3f obj) { int o = __offset(4); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  ...
  public int Xsegments() { int o = __offset(12); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; }
  public int Ysegments() { int o = __offset(14); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; }
  public byte Normals() { int o = __offset(16); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; }
  public int NumTexCoordSets() { int o = __offset(18); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; }
  ...
  public Vec3f UpVector(Vec3f obj) { int o = __offset(24); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }

  public static void StartOgrePlane(FlatBufferBuilder builder) { builder.StartObject(11); }
  public static void AddNormal(FlatBufferBuilder builder, int normalOffset) { builder.AddOffset(0, normalOffset, 0); }
  ...
  public static void AddXsegments(FlatBufferBuilder builder, int xsegments) { builder.AddInt(4, xsegments, 0); }
  public static void AddYsegments(FlatBufferBuilder builder, int ysegments) { builder.AddInt(5, ysegments, 0); }
  public static void AddNormals(FlatBufferBuilder builder, byte normals) { builder.AddByte(6, normals, 0); }
  public static void AddNumTexCoordSets(FlatBufferBuilder builder, int numTexCoordSets) { builder.AddInt(7, numTexCoordSets, 0); }
  ...
  public static void AddUpVector(FlatBufferBuilder builder, int upVectorOffset) { builder.AddOffset(10, upVectorOffset, 0); }
  public static int EndOgrePlane(FlatBufferBuilder builder) { return builder.EndObject(); }
};
